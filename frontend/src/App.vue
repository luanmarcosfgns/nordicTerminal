...
export default {
  ...
  created() {
    let titleElement = '<title>' + process.env.VUE_APP_APPLICATION_NAME + '</title>';
    let headElement = document.querySelector('head');
    headElement.innerHTML = headElement.innerHTML + titleElement;
...
.btn-primary {
  ...
  --bs-btn-border-color: #222d3f !important;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #2b3b4d !important;
  --bs-btn-hover-border-color: #2b3b4d !important;

  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #2b3b4d !important;
  --bs-btn-active-border-color: #2b3b4d !important;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
  --bs-btn-disabled-bg: #2b3b4d !important;
  --bs-btn-disabled-border-color: #2b3b4d !important;
}
...
.btn-ouro {
  ...
  background-color: #FDBB2DFF !important;
  border-color: #f6b72e !important;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(17, 24, 39, 0.075) !important;
}
